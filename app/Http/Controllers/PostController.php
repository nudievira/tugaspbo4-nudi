...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $post = Posts::create([
            ...
            'gambar' => 'public/uplods/posts/'.$new_gambar,
        ...
        $gambar->move('public/uplods/posts/', $new_gambar);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success','Post Berhasil dipindahkan');
    }
    ...
    public function restore($id){
        ...
        return redirect()->back()->with('success','Post Berasil DiKembalikan');
    }
