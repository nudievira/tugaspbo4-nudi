<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from gambolthemes.net/html-items/gambo_supermarket_demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Jan 2021 09:30:18 GMT -->
...
<head>
    ...
    {{-- <link href="{{asset('template')}}/css/produkdisable.css" rel="stylesheet"> --}}
    {{-- load produkdisable.css --}}
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('template') }}/vendor/semantic/semantic.min.css">
</head>
...
<body>
                    ...
                    <ul class="category-by-cat">
                        <li>
                            <a href="#" class="single-cat-item">
                                <div class="icon">
                                    <img src="{{ asset('template') }}/images/category/icon-1.svg" alt="">
                                </div>
                        ...
                        <li>
                            <a href="#" class="single-cat-item">
                                <div class="icon">
                                    <img src="{{ asset('template') }}/images/category/icon-2.svg" alt="">
                                </div>
                        ...
                        <li>
                            <a href="#" class="single-cat-item">
                                <div class="icon">
                                    <img src="{{ asset('template') }}/images/category/icon-3.svg" alt="">
                                </div>
                        ...
                        <li>
                            <a href="#" class="single-cat-item">
                                <div class="icon">
                                    <img src="{{ asset('template') }}/images/category/icon-4.svg" alt="">
                                </div>
                        ...
                        <li>
                            <a href="#" class="single-cat-item">
                                <div class="icon">
                                    <img src="{{ asset('template') }}/images/category/icon-5.svg" alt="">
                                </div>
                        ...
                        <li>
                            <a href="#" class="single-cat-item">
                                <div class="icon">
                                    <img src="{{ asset('template') }}/images/category/icon-6.svg" alt="">
                                </div>
                        ...
                        <li>
                            <a href="#" class="single-cat-item">
                                <div class="icon">
                                    <img src="{{ asset('template') }}/images/category/icon-7.svg" alt="">
                                </div>
                        ...
                        <li>
                            <a href="#" class="single-cat-item">
                                <div class="icon">
                                    <img src="{{ asset('template') }}/images/category/icon-8.svg" alt="">
                                </div>
                        ...
                        <li>
                            <a href="#" class="single-cat-item">
                                <div class="icon">
                                    <img src="{{ asset('template') }}/images/category/icon-9.svg" alt="">
                                </div>
            ...
            <div class="side-cart-items">
                <div class="cart-item">
                    <div class="cart-product-img">
                        <img src="{{ asset('template') }}/images/product/img-1.jpg" alt="">
                ...
                <div class="cart-item">
                    <div class="cart-product-img">
                        <img src="{{ asset('template') }}/images/product/img-2.jpg" alt="">
                        <div class="offer-badge">6% OFF</div>
                    </div>
                    <div class="cart-text">
                        <h4>Product Title Here</h4>
        ...
        <div class="top-header-group">
            <div class="top-header">
                <div class="res_main_logo">
                    <a href="index.html"><img src="{{ asset('template') }}/images/dark-logo-1.svg" alt=""></a>
                </div>
                <div class="main_logo" id="logo">
                    <a href="index.html"><img src="{{ asset('template') }}/images/logo.svg" alt=""></a>
                    <a href="index.html"><img class="logo-inverse" src="{{ asset('template') }}/images/dark-logo.svg"
                            alt=""></a>
                </div>
                    ...
                    <ul>
                        ...
                        <li class="ui dropdown">
                            <a href="#" class="opts_account">
                                <img src="{{ asset('template') }}/images/avatar/img-5.jpg" alt="">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-end bg-dark1 p-3 p-lg-0 mt1-5 mt-lg-0 mobileMenu"
                            ...
                            <ul class="navbar-nav main_nav align-self-stretch">
                                <li class="nav-item"><a href="index.html" class="nav-link active" title="Home">Home</a>
                                </li>
                                <li class="nav-item"><a href="shop_grid.html" class="nav-link new_item"
                                        title="New Products">New Products</a></li>
                                <li class="nav-item"><a href="shop_grid.html" class="nav-link"
                                ...
                                <li class="nav-item">
                                    <div class="ui icon top left dropdown nav__menu">
                                        ...
                                        <div class="menu dropdown_page">
                                            ...
                                            <a href="blog_no_sidebar.html" class="item channel_item page__links">Our
                                                Blog Two No Sidebar</a>
                                            <a href="blog_left_sidebar.html" class="item channel_item page__links">Our
                                                Blog with Left Sidebar</a>
                                            <a href="blog_right_sidebar.html" class="item channel_item page__links">Our
    ...
    <div class="wrapper">
                        ...
                        <div class="owl-carousel offers-banner owl-theme">
                            <div class="item">
                                <div class="offer-item">
                                    <div class="offer-item-img">
                                        ...
                                        <img src="{{ asset('template') }}/images/banners/offer-1.jpg" alt="">
                                    </div>
                            ...
                            <div class="item">
                                <div class="offer-item">
                                    <div class="offer-item-img">
                                        <div class="gambo-overlay"></div>
                                        <img src="{{ asset('template') }}/images/banners/offer-2.jpg" alt="">
                                    </div>
                                    <div class="offer-text-dt">
                                        <div class="offer-top-text-banner">
                                            <p>5% Off</p>
                            ...
                            <div class="item">
                                <div class="offer-item">
                                    <div class="offer-item-img">
                                        <div class="gambo-overlay"></div>
                                        <img src="{{ asset('template') }}/images/banners/offer-3.jpg" alt="">
                                    </div>
                                    <div class="offer-text-dt">
                                        <div class="offer-top-text-banner">
                                            <p>3% Off</p>
                            ...
                            <div class="item">
                                <div class="offer-item">
                                    <div class="offer-item-img">
                                        <div class="gambo-overlay"></div>
                                        <img src="{{ asset('template') }}/images/banners/offer-4.jpg" alt="">
                                    </div>
                                    <div class="offer-text-dt">
                                        <div class="offer-top-text-banner">
                                            <p>2% Off</p>
                            ...
                            <div class="item">
                                <div class="offer-item">
                                    <div class="offer-item-img">
                                        <div class="gambo-overlay"></div>
                                        <img src="{{ asset('template') }}/images/banners/offer-5.jpg" alt="">
                                    </div>
                                    <div class="offer-text-dt">
                                        <div class="offer-top-text-banner">
                                            <p>3% Off</p>
                    ...
                    <div class="col-md-12">
                        <div class="owl-carousel cate-slider owl-theme">
                            ...
                            <div class="item">
                                <a href="#" class="category-item">
                                    <div class="cate-img">
                                        <img src="{{ asset('template') }}/images/category/icon-10.svg" alt="">
                                    </div>
                                    <h4> Meat & Seafood </h4>
                                </a>
                            </div>
                            <div class="item">
                                <a href="#" class="category-item">
                                    <div class="cate-img">
                                        <img src="{{ asset('template') }}/images/category/icon-11.svg" alt="">
                                    </div>
                                    <h4> Electronics </h4>
                                </a>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="owl-carousel featured-slider owl-theme">
                            ...
                            <div class="item">
                                <div class="product-item">
                                    <a href="single_product_view.html" class="product-img">
                                        <img src="{{ asset('template') }}/images/product/img-3.jpg" alt="">
                                        <div class="product-absolute-options">
                            ...
                            <div class="item">
                                <div class="product-item">
                                    <a href="single_product_view.html" class="product-img">
                                        <img src="{{ asset('template') }}/images/product/img-4.jpg" alt="">
                                        <div class="product-absolute-options">
                            ...
                            <div class="item">
                                <div class="product-item">
                                    <a href="single_product_view.html" class="product-img">
                                        <img src="{{ asset('template') }}/images/product/img-7.jpg" alt="">
                                        <div class="product-absolute-options">
                            ...
                            <div class="item">
                                <div class="product-item">
                                    <a href="single_product_view.html" class="product-img">
                                        <img src="{{ asset('template') }}/images/product/img-8.jpg" alt="">
                                        <div class="product-absolute-options">
                                            <span class="offer-badge-1">3% off</span>
                                            <span class="like-icon" title="wishlist"></span>
                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="#" class="best-offer-item">
                            <img src="{{ asset('template') }}/images/best-offers/offer-1.jpg" alt="">
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <a href="#" class="best-offer-item">
                            <img src="{{ asset('template') }}/images/best-offers/offer-2.jpg" alt="">
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <a href="#" class="best-offer-item offr-none">
                            <img src="{{ asset('template') }}/images/best-offers/offer-3.jpg" alt="">
                            <div class="cmtk_dt">
                    ...
                    <div class="col-md-12">
                        <a href="#" class="code-offer-item">
                            <img src="{{ asset('template') }}/images/best-offers/offer-4.jpg" alt="">
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="owl-carousel featured-slider owl-theme">
                            <div class="item">
                                <div class="product-item">
                                    <a href="single_product_view.html" class="product-img">
                                        <img src="{{ asset('template') }}/images/product/img-11.jpg" alt="">
                                        <div class="product-absolute-options">
                                            <span class="offer-badge-1">6% off</span>
                                            <span class="like-icon" title="wishlist"></span>
                                        </div>
                            ...
                            <div class="item">
                                <div class="product-item">
                                    <a href="single_product_view.html" class="product-img">
                                        <img src="{{ asset('template') }}/images/product/img-12.jpg" alt="">
                                        <div class="product-absolute-options">
                                            <span class="offer-badge-1">2% off</span>
                                            <span class="like-icon" title="wishlist"></span>
                                        </div>
                            ...
                            <div class="item">
                                <div class="product-item">
                                    <a href="single_product_view.html" class="product-img">
                                        <img src="{{ asset('template') }}/images/product/img-13.jpg" alt="">
                                        <div class="product-absolute-options">
                                            <span class="offer-badge-1">5% off</span>
                                            <span class="like-icon" title="wishlist"></span>
                                        </div>
                            ...
                            <div class="item">
                                <div class="product-item">
                                    <a href="single_product_view.html" class="product-img">
                                        <img src="{{ asset('template') }}/images/product/img-14.jpg" alt="">
                                        <div class="product-absolute-options">
                                            <span class="offer-badge-1">1% off</span>
                                            <span class="like-icon" title="wishlist"></span>
                                        </div>
        ...
        <!-- prodak baru-->
        @include('template_frontend.prodak_baru')
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <ul class="call-email-alt">
                                <li><a href="#" class="callemail"><i class="uil uil-dialpad-alt"></i>1800-000-000</a>
                                </li>
                                <li><a href="#" class="callemail"><i class="uil uil-envelope-alt"></i><span
                                            class="__cf_email__"
                                            data-cfemail="a5cccbc3cae5c2c4c8c7cad6d0d5c0d7c8c4d7cec0d18bc6cac8">[email&#160;protected]</span></a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="second-row-item-app">
                                ...
                                <ul>
                                    <li><a href="#"><img class="download-btn"
                                                src="{{ asset('template') }}/images/download-1.svg" alt=""></a></li>
                                    <li><a href="#"><img class="download-btn"
                                                src="{{ asset('template') }}/images/download-2.svg" alt=""></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="copyright-text">
                                <i class="uil uil-copyright"></i>Copyright 2020 <b>Gambolthemes</b> . All rights
                                reserved
                            </div>
                        </div>
                    </div>
        ...
        <script src="{{ asset('template') }}/vendor/OwlCarousel/owl.carousel.js"></script>
        <script src="{{ asset('template') }}/vendor/semantic/semantic.min.js"></script>
        <script src="{{ asset('template') }}/js/jquery.countdown.min.js"></script>
        <script src="{{ asset('template') }}/js/custom.js"></script>
        <script src="{{ asset('template') }}/js/offset_overlay.js"></script>
        <script src="{{ asset('template') }}/js/night-mode.js"></script>
</body>

<!-- Mirrored from gambolthemes.net/html-items/gambo_supermarket_demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Jan 2021 09:30:23 GMT -->
